...
IPC.tr.d1.d12_descompose = decompose(IPC.tr.d1.d12[,1])
...
IPC.tr.d1.d12_stl = stl(IPC.tr.d1.d12[,1], s.window = "periodic")

# HoltWinters
HoltWinters(ipcIndex.ts, beta=FALSE)
HoltWinters(IPCmonthVariation.ts, beta=FALSE)
HoltWinters(Inflation, beta=FALSE)
HoltWinters(IPC.tr.d1.d12, beta=FALSE)

# descompose graficos
plot(ipc_descompose, sub='Ipc descompose')
plot(monthly_descompose_ipc, sub='Ipc monthly')
plot(inflation_descompose, sub='inflation inflation')
plot(IPC.tr.d1.d12_descompose, sub='IPC.tr.d1.d12 descompose')

# stl graficos
plot_ipc_stl = plot(ipc_stl, sub="Ipc stl")
plot(monthly_stl_ipc, main="Monthly stl")
plot(inflation_stl, main="Inflation stl")
plot(IPC.tr.d1.d12_stl, main="IPC.tr.d1.d12_stl")
