...
```{r}
#ARMA model 2
arma.12.12.IPC.tr.d1.d12 = Arima(IPC.tr.d1.d12, order = c(1, 0, 0))
...
El modelo sugerido por auto.arma es:

ARIMA(1,0,0)(0,0,1) with zero mean

c\. Escojeria el modelo proporcionado por aurto.arima, ya que su autocorrelación sigue una tendencia más orgánica que la de las dos otras ARMAs y su varianza es notablemente menor.
