...
Por otra parte, la predicción de HW suaviza la curva más que el modelo ARIMA, y éste modelo realizó una predicción más precisa de la tendencia y los picos de la curva al seguir el mismo patron que los valores de IPC.te.
