...
#Variables contínuas
hist(data$antig)
hist(data$Total_activo)
hist(data$Total_Plazo)
hist(data$Total_Inversion)
hist(data$Total_Seguros)
hist(data$Total_Vista)
hist(data$oper_caj_Libreta)
hist(data$oper_ven_Libreta)
hist(data$dif_CC)
hist(data$dif_Libreta)
hist(data$dif_Plazo)
hist(data$dif_Ahorro)
hist(data$dif_Largo_plazo)
hist(data$dif_Fondos_inv)
hist(data$dif_Seguros)
hist(data$dif_Planes_pension)
hist(data$dif_Hipoteca)
hist(data$dif_Seguros)
hist(data$dif_Prest_personales)
```
